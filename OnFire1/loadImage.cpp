...
{    
   ...
   program = InitShader( "fbmnoise.vert", "fbmnoise.frag" );
   ...
   glTexImage2D(GL_TEXTURE_2D, 0, ilGetInteger(IL_IMAGE_BPP), ilGetInteger(IL_IMAGE_WIDTH), ilGetInteger(IL_IMAGE_HEIGHT),0,
	   ilGetInteger(IL_IMAGE_FORMAT), ilGetInteger(IL_IMAGE_TYPE), firepix);
	...
	texMap = glGetUniformLocation(program, "permTexture");
	...
	glVertexAttribPointer(texCoord, 2, GL_FLOAT, GL_FALSE, 0, 0);
	  ...
	  location_time = glGetUniformLocation( program, "utime" );
